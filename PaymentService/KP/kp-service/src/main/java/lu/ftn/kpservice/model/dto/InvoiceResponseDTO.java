...
public class InvoiceResponseDTO {
    ...
    private BigDecimal transferredCurrencyAmount;
    ...
    public InvoiceResponseDTO(String id, String orderId, String url, String guid, String token, String itemDescription, String status, String exceptionStatus, String currency, BigDecimal transferredCurrencyAmount, String transactionCurrency, BigDecimal transferredTransactionCurrencyAmount, Long utcTransactionTime) {
        this.id = id;
    ...
    public BigDecimal getTransferredCurrencyAmount() {
        return transferredCurrencyAmount;
    }

    public void setTransferredCurrencyAmount(BigDecimal transferredCurrencyAmount) {
        this.transferredCurrencyAmount = transferredCurrencyAmount;
    }
