...
public class InvoiceCreationDTO {
    ...
    public InvoiceCreationDTO(String merchantOrderId, String storeId, String successRedirectUrl, String failureRedirectUrl, String errorRedirectUrl, BigDecimal amount, String currency) {
