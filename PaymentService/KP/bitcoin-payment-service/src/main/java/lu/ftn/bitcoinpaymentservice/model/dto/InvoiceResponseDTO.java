...
public class InvoiceResponseDTO {
    ...
    public InvoiceResponseDTO(Invoice invoice) {
        ...
        this.guid = invoice.getGuid();
        this.token = invoice.getToken();
        this.itemDescription = invoice.getItemDesc();
        this.status = invoice.getStatus();
        this.exceptionStatus = invoice.getExceptionStatus();
        this.currency = invoice.getCurrency();
        this.transferredCurrencyAmount = invoice.getPrice();
        this.transactionCurrency = invoice.getTransactionCurrency();
        this.transferredTransactionCurrencyAmount = invoice.getAmountPaid();
        this.utcTransactionTime = invoice.getCurrentTime();
    }
