...
@Service
public class BetaReaderGenresStartListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        FormField field = formFields.stream().filter(formField -> formField.getId().equals("betaGenres")).collect(Collectors.toList()).get(0);
