...
public class WriterRegistrationDTO implements Serializable {
    ...
    public WriterRegistrationDTO(String username, String password, String name, String surname, String city, String country, String email, List<Genre> genres) {
    ...
    public WriterRegistrationDTO(List<FormSubmissionDTO> dtos) {
