...
@Service
public class ChooseEditorsToEvaluateStartTaskListener implements TaskListener {
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        FormField field = formFields.stream().filter(formField -> formField.getId().equals("chosen_editors")).collect(Collectors.toList()).get(0);
