...
public class LectorMarksErrorsCreateListener implements TaskListener {
    @Override
    public void notify(DelegateTask delegateTask) {
        ...
        FormField field = formFields.stream().filter(formField -> formField.getId().equals("needsCorrections")).collect(Collectors.toList()).get(0);
